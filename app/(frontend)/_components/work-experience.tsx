...
// Map legacy keys to React Icon names for backward compatibility
const legacyIconMap: Record<string, string> = {
  business: "MdBusinessCenter",
  code: "FaCode",
  design: "MdBrush", // or SiFigma or something
...
export function ExperiencePositionItem({
  ...
  // Resolve icon name: use legacy map if it exists, otherwise use raw input
  const iconName = legacyIconMap[position.icon || ""] || position.icon || "MdBusinessCenter"; 
